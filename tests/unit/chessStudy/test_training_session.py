...
from chessStudy.tactic.models import AttemptStats
from chessStudy.training_session import PuzzleInfo, TrainingOptions, TrainingSession
...
class TestDrawing(TrainingSessionTestCase):
	...
	def test_missing_database_is_file_not_found(self):
		...
		with mock.patch("chessStudy.training_session.resolve_default_db_path", return_value=None):
