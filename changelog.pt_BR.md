...
- A revisão da partida segue a configuração "Saída da barra de progresso" do NVDA: com bipes (o padrão do NVDA), um bipe curto a cada posição revisada, subindo como nas barras de progresso do NVDA; com fala, os quartos como antes; os dois, ou nada. O início diz o tempo como uma pessoa diz: "cerca de 1 minuto e 30 segundos", e não "cerca de 86 segundos".
- **Minhas partidas...** no menu: as partidas da pasta de partidas, as alteradas mais recentemente primeiro, cada uma com data, jogadores, resultado e quanto já foi anotada (comentários, marcas, variantes). Enter abre no tabuleiro de análise. Há um comando em Definir gestos, sem tecla de fábrica.
