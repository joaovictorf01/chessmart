...
DEFAULT_MANIFEST_URL = (
	"https://github.com/joaovictorf01/chessStudy/releases/download/puzzles-latest/manifest.json"
)
...
def manifest_url() -> str:
	...
	override = os.environ.get("CHESS_STUDY_PUZZLES_MANIFEST_URL")
	if override:
		return override
...
USER_AGENT = "chessStudy-nvda-addon/1.0"
CHUNK = 256 * 1024
