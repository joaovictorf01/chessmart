...
class AnalysisEngine:
	...
	def quit(self) -> None:
		...
		try:
			...
			log.debug("chessStudy: analysis engine already gone")
...
def result_of(future: Future):
	...
	try:
		...
		log.warning("chessStudy: analysis engine failed: %s", error)
		return None, error
	except Exception as error:
		log.exception("chessStudy: analysis request failed")
		return None, error
